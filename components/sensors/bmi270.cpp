...
/*
  config file from offical example of BOSCH
*/
// const uint8_t DRAM_ATTR bmi270_config_file[] = {
...
BMI270::BMI270(const uint8_t dev_addr): EF_I2C::EF_I2C_device(dev_addr)
{
    /*
    ...
    */
    uint8_t data = 0x00;
    ESP_LOGI("BMI270", "1");
    EF_I2C_read(data, &data, 1);
    assert(data == 0x24);
    ESP_LOGI("BMI270", "1");
    EF_I2C_write(BMI270_PWR_CONF, &data, 1);
    ESP_LOGI("BMI270", "2");
    vTaskDelay(pdMS_TO_TICKS(1));
    EF_I2C_write(BMI270_INIT_CTRL, &data, 1);
    ESP_LOGI("BMI270", "3");
    EF_I2C_write(BMI270_INIT_DATA, bmi270_config_file, sizeof(bmi270_config_file));
    ESP_LOGI("BMI270", "4");
    data = 0x01;
    EF_I2C_write(BMI270_INIT_CTRL, &data, 1);
    ...
    */
    ...
    data = 0x0E;
    EF_I2C_write(BMI270_PWR_CTRL, &data, 1);
    data = 0xA8;
    EF_I2C_write(BMI270_ACC_CONF, &data, 1);
    data = 0xE9;
    EF_I2C_write(BMI270_GYRO_CONF, &data, 1);
    data = 0x02;
    EF_I2C_write(BMI270_PWR_CONF, &data, 1);
    ...
    */
    ...
    data = 0x00 | acc_range;
    EF_I2C_write(BMI270_ACC_RANGE, &data, 1);
    data = 0x00 | gyro_range;
    EF_I2C_write(BMI270_GYRO_RANGE, &data, 1);
}
